...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function revealMessage() {
    ...
    // Fade out black overlay to reveal navy gradient background
    const blackOverlay = document.getElementById('chairman-black-overlay');
    if (blackOverlay) blackOverlay.classList.add('fade-out');
